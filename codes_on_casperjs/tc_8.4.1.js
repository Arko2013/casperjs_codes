...
Author: Kunal
Description:This is a casperjs automation script to show the source code in editable format


*/

casper.test.begin("Show source code", 3, function suite(test) {
	...
	//Now clicking on the show source
	...
	casper.viewport(1366,768).then(function(){
		...
		{
			this.wait(5000);
			console.log('Show source selected');
		}
		else
		{	
		console.log('Show source not selected');
	}
	});
