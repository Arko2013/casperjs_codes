...
Author: Kunal
Description:This is a casperjs automation script for writing code in a R cell, executing it and then again switching back to check the source code
*/
casper.test.begin("Source code", 3, function suite(test) {
