...
Author: Kunal
Description:This is a casperjs automation script for checking that for the given combination,selecting Coalesce Cell option for the bottom cell 
			results in merging of the bottom cell with the top one. The content of R cell is enclosed within "…{r}" and "…"
			
*/
casper.test.begin("Combination of R cell beneath and Markdown cell on top of it", 3, function suite(test) {
	...
	casper.viewport(1366,768).then(function(){
		this.wait(15000);
		//checking whether cells were coalesced or no
		var temp = source_r_code;
		console.log('contents of the coalesced cell :');
		...
		//this.test.assertNotEquals(coalesce,temp,'Code has been successfully coalesced');
