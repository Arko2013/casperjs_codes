...
Description:This is a casperjs automation script for notebook containing one R cell and one RMarkdown cell with some code 
 			which is already executed and Run all button is then clicked and checked wheather the R and markdown cell are 
 			executed or no.
...
casper.test.begin("Execute pre executed R cell", 3, function suite(test) {
	...
	// Add a RMarkdown cell by clicking the add-cell button on the above R cell
