...
Author: Kunal
Description:This is a casperjs automation script for checking that if the Split Cell option for the 
			topmost cell is selected, no new cell is created
*/
casper.test.begin("Clicking Split Cell option for the first cell", 4, function suite(test) {
	...
	casper.viewport(1366,768).then(function(){
		this.thenClick({type:'xpath',path:'/html/body/div[3]/div/div[3]/div/div/div/div/div/table/td[2]/span/i'},'Edit button clicked');
	});
